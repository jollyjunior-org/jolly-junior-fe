      ...
      <div className="bg-[#0798AE] text-white text-xs py-2 px-4 font-medium border-b border-[#D9F1F5]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          <div className="flex items-center gap-4">
            <span className="inline-flex items-center gap-1.5 font-bold text-[10px] sm:text-xs">
              🚚 Free Delivery on orders over Rs. 3,000
            </span>
          </div>
          <div className="flex items-center gap-5 text-[11px] sm:text-xs font-semibold">
            <a
              href={`https://wa.me/${cleanWhatsappNum}?text=Hi%20JollyJuniors!`}
              target="_blank"
              rel="noreferrer"
              className="hidden sm:inline-flex items-center gap-1.5 font-bold text-white hover:underline"
            >
